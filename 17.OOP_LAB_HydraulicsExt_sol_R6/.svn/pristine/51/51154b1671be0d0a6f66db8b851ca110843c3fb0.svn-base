...
public class TestR2_SimpleElements {
	...
	public void testConnections(){
		...
		assertSame("Wrong output for element src, ", tap, src.getOutput());
		assertSame("Wrong output for element tap, ", sink, tap.getOutput());
	}
	...
	public void testSinkConnect(){
		...
		assertSame("Connect on a sink should have no effect, ", none, out);
	}
