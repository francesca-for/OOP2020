...
public class Food {
	...
	public Collection<NutritionalElement> rawMaterials(){
		return rawMaterials.values(); // restituisce TreeSet di cui è composta la TreeMp
	}
	...
	public void defineProduct(String name,
								  ...
								  double carbs,
								  double fat){
		Product pr = new Product(name, calories, proteins, carbs, fat);
	...
	public Collection<NutritionalElement> products(){
		return products.values();  // restituisce elenco prodotti ordinato
	}
	...
	public Collection<NutritionalElement> recipes(){
		return recipes.values();  // restituisce elenco ricette ordinato
	}
