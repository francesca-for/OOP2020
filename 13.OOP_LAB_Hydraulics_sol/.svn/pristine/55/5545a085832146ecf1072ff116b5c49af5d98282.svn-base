...
public class TestR3_ComplexElements {
	...
	public void testSplitName(){
		...
		assertEquals("Wrong name for split element",
				"Split name",t.getName());
	}
	...
	public void testSplit(){
		...
		assertSame("Wrong output 0 for Split", sink1, out[0]);
		assertSame("Wrong output 1 for Split", sink2, out[1]);
	}
